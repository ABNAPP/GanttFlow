          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-lg border border-gray-100 dark:border-gray-700">
            ...
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                { key: 'executor', label: 'HL', highlight: true },
                { key: 'cad', label: 'CAD' },
                ...
                <div key={key}>
                  <label className={`text-[10px] font-bold ${highlight ? 'text-indigo-500 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'}`}>
                    {label}
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full border ${highlight ? 'border-indigo-200 dark:border-indigo-800 bg-indigo-50 dark:bg-indigo-900/40' : 'border-gray-200 dark:border-gray-600 dark:bg-gray-700'} rounded px-2 py-1 text-sm`}
                    aria-label={label}
                  />
                </div>
              ))}
